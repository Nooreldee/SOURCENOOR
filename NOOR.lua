...
print('\n\27[1;34m Welcome to the all-new and powerful Source NOOR ')
file = io.open("NOOR", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/NOOR
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./NOOR.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BK", "w")  
...
if hash or SudoBot(msg) or DevNOORW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevNOORW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevNOORW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevNOORW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevNOORW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevNOORW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevNOORW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
NOOR_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
NOOR_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
NOOR_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
NOOR_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
NOOR_Msg = 'فاجر التفاعل'  
end 
return NOOR_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceNOOR(msg,data) -- بداية العمل
if msg then
...
if DevNOORW(msg) then
local bl = ' ❃∫ اهلا عزيزي آلمـطـور\n ❃∫ آنت آلمـطـور آلآسـآسـي للبوت\n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉ء\n ❃∫ تسـتطـيع‌‏ آلتحگم باوامر البوت\n ❃∫ من خلاال الكيبورت خاص بك\n ❃∫ قناة سورس البوت [اضغط هنا](https://t.me/source_noor)'
local keyboard = {
...
SourceNOORr = '❃∫ اهلا عزيزي\n ❃∫ انا بوت اسمي '..Namebot..'\n ❃∫ اختصاصي حمايه الجروبات\n ❃∫ من تكرار والسبام والتوجيه والخ…\n ❃∫ لتفعيلي اتبع الاخطوات…↓\n ❃∫ اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط\n[ ❃∫ [قناة سورس البوت](http://https://t.me/source_noor)'
end 
send(msg.chat_id_, msg.id_, SourceNOORr) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not DevNOORW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevNOORW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,NOOR_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ❃' and DevNOORW(msg) then  
...
if text == 'تعطيل التواصل ❃' and DevNOORW(msg) then  
...
if text == 'تفعيل البوت الخدمي ❃' and DevNOORW(msg) then  
...
if text == 'تعطيل البوت الخدمي ❃' and DevNOORW(msg) then  
...
if text == 'ضع كليشه ستارت ❃' and DevNOORW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ❃∫ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ❃' and DevNOORW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ❃' and DevNOORW(msg) then 
...
if text == 'تحديث السورس ❃' and DevNOORW(msg) then 
os.execute('rm -rf NOOR.lua')
os.execute('wget https://raw.githubusercontent.com/NOORTEAM/NOOR/master/NOOR.lua')
send(msg.chat_id_, msg.id_,' ❃∫ تم تحديث السورس \n ❃∫ لديك اخر اصدار لسورس بويكا\n ❃∫ الاصدار » { 6.7v}')
dofile('NOOR.lua')  
end
if text == 'تحديث المتجر ❃' and DevNOORW(msg) then 
  io.popen("mkdir File_Bot")
  io.popen("cd File_Bot && rm -rf ga.lua.1") 
  io.popen("cd File_Bot && rm -rf ga.lua.2") 
  io.popen("cd File_Bot && rm -rf ga.lua.3") 
  io.popen("cd File_Bot && wget https://raw.githubusercontent.com/NOORTEAM/Files_NOOR/master/File_Bot/ga.lua")  
  io.popen("cd File_Bot && wget https://raw.githubusercontent.com/NOORTEAM/Files_NOOR/master/File_Bot/rd.lua") 
  send(msg.chat_id_, msg.id_,' ❃∫ تم تحديث \n ❃∫ لديك اخر اصدار للمتجر')
  dofile('NOOR.lua')  
  end
if text == 'رقم البناء ❃' and DevNOORW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ اهلاء عزيزي \n رقم البناء خاص بوتك {lua~{m7a29}')
end
if text == 'الاصدار ❃' and DevNOORW(msg) then 
  database:del(bot_id..'Srt:Bot') 
  send(msg.chat_id_, msg.id_,' ❃∫ اصدار سورس بويكا \n ❃∫ الاصدار »{ 6.7v}')
  end
  if text == 'مطور السورس ❃' and DevNOORW(msg) then 
    database:del(bot_id..'Srt:Bot') 
    send(msg.chat_id_, msg.id_,' ❃∫ تنويه : قبل لا تراسل المطور تاكد انو عندك شغله مهمه \n\n المطور - @JJEJJ ')
    end
if text == 'قناه تحديثات البوت ❃' and DevNOORW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ [تحديثات البوت](https://t.me/source_noor) \n ❃∫ [قناه السورس](https://t.me/source_noor)')
end
if text == "ضع اسم للبوت ❃" and DevNOORW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ❃' and DevNOORW(msg) then 
...
if text == 'المشتركين ❃' and DevNOORW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❃∫ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الجروبات ❃' and DevNOORW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❃∫ الجروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ❃") and DevNOORW(msg) then
...
if text == ("قائمه العام ❃") and DevNOORW(msg) then
...
if text == ("قائمه الكتم العام ❃") and DevNOORW(msg) then
...
if text=="اذاعه خاص ❃" and msg.reply_to_message_id_ == 0 and DevNOORW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ❃" and msg.reply_to_message_id_ == 0 and DevNOORW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ❃" and msg.reply_to_message_id_ == 0 and DevNOORW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل الان اذاعتك؟ \n ❃∫ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ❃" and msg.reply_to_message_id_ == 0  and DevNOORW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ❃" and msg.reply_to_message_id_ == 0  and DevNOORW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❃∫ ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ❃' and DevNOORW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ❃" and DevNOORW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الجروبات ❃" and DevNOORW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'❃∫  عدد الجروبات الان » { '..#group..' }'..NOORk..''..NOOR..'\n❃∫  الان عدد الجروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevNOORW(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevNOORW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevNOORW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevNOORW(msg) then
...
local NOOR1_Msg = database:get(bot_id.."NOOR1:Add:Filter:Rp2"..text..msg.chat_id_)   
if NOOR1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if NOOR_Msg and not Special(msg) then  
local NOOR_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if NOOR_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❃∫ ["..NOOR_Msg.."] \n")
else
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](https://t.me/source_noor)}\n ❃∫ ["..NOOR_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ❃∫ عذرا » {["..data.first_name_.."](https://t.me/source_noor)}\n ❃∫ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevNOORW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevNOORW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevNOORW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevNOORW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ❃" and DevNOORW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ❃∫ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ❃$") and DevNOORW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ❃∫ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ❃" and DevNOORW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ❃" and DevNOORW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ❃∫ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ❃" and DevNOORW(msg) then  
...
database:sadd(bot_id.."NOOR:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."NOOR:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_NOOR = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_NOOR then 
names_NOOR = database:smembers(bot_id.."NOOR:blocname"..msg.chat_id_) or ""
if names_NOOR and names_NOOR[1] then 
for i=1,#names_NOOR do 
if name_NOOR:match("(.*)("..names_NOOR[i]..")(.*)") then 
...
database:set(bot_id.."NOOR:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."NOOR:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."NOOR:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."NOOR:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."NOOR:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_NOORa_new(NOOR1,NOOR2)
if NOOR2 and NOOR2.first_name_ then 
if NOOR2.first_name_:match("(.*)"..database:get(bot_id.."NOOR:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."NOOR:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local NOOR_nnn = database:get(bot_id.."NOOR:nump"..msg.chat_id_) or 5
local NOOR_nnn2 = database:get(bot_id.."NOOR:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(NOOR_nnn2) == tonumber(NOOR_nnn) or tonumber(NOOR_nnn2) > tonumber(NOOR_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."NOOR:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "❃∫ عزيزي >>["..NOOR2.username_.."](https://t.me/"..(NOOR2.username_ or "BO6OK")..")\n❃∫ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."NOOR:teh"..msg.chat_id_).."} بجانب اسمك\n❃∫ عدد المحاولات المتبقيه {"..(tonumber(NOOR_nnn) - tonumber(NOOR_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_NOORa_new)
end
end
...
local NOORChengName = database:get(bot_id.."NOOR:Cheng:Name"..data.id_)
if not data.first_name_ then 
if NOORChengName then 
send(msg.chat_id_, msg.id_, " تغيير الاسم ["..NOORChengName..']')
database:del(bot_id.."NOOR:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if NOORChengName ~= data.first_name_ then 
local Text = {
  "اي الاسم داا",
"غيرت اسمك لي يعم ",
"القمور دا غير اسمه 😉",
...
database:set(bot_id.."NOOR:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local NOORChengUserName = database:get(bot_id.."NOOR:Cheng:UserName"..data.id_)
if not data.username_ then 
if NOORChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..NOORChengUserName..']')
database:del(bot_id.."NOOR:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if NOORChengUserName ~= data.username_ then 
local Text = {
'غيرت يوزرك لي يخواف😂🥺',
"هاها غيرت يوزرك لي حد بيهددك",
"في اي غيرت يوزرك😐🌝",
"غير يوزره الول \n دا يوزره@"..data.username_.."",
' غيرت يوزرك لي  \n للدرجاتي خايف@'..data.username_..' ',
'ها غيرت يوزرك لي هتختفي ولا اي ', 
"منور اليوزر الجديد :  "..data.username_.."",
}
send(msg.chat_id_, msg.id_,Text[math.random(#Text)])
end  
database:set(bot_id.."NOOR:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local NOORChengPhoto = database:get(bot_id.."NOOR:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if NOORChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صوره ابن الحلو  غبي اوي😂🥺")
database:del(bot_id.."NOOR:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if NOORChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
  "اي غيرت صورتك يبني",
  "طالع قمور ف الصوره الجديده ",
    "ها يقميل غيرت صورتك لي 😍😂",
  "اي غيرت صورتك شقطت واحده جديده 😹😹🌚",
  "اي غيرت صورتك اتقفشت ولا اي  ؟😹🌞",
  "الاه غيرت صورتك ؟؟ 🤔🌞"
}
send(msg.chat_id_, msg.id_,Text[math.random(#Text)])
end  
database:set(bot_id.."NOOR:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
Text = [[
  ...
  ↬ .NOOR TEAM  
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
  ↬ . [Channel](https://t.me/source_noor)  
  
  ↬ . [DEVELOPER]( t.me/NOOR_ELDEEN_0)       
   
  ↬ . [Information](https://t.me/source_noor) 
   
  ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉  
  ↬ . [MN](https://t.me/M_I_D_N_I_G_H_T_0)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if text == 'رفع نسخه الاحتياطيه' and DevNOORW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevNOORW(msg) then    
dofile('NOOR.lua')  
send(msg.chat_id_, msg.id_, ' ❃∫ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevNOORW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevNOORW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevNOORW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevNOORW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevNOORW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevNOORW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevNOORW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevNOORW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevNOORW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevNOORW(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevNOORW(msg) then
...
if text == 'الملفات' and DevNOORW(msg) then
...
if DevNOORW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/NOORTEAM/Files_NOOR/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ❃∫ اهلا بك في متجر ملفات بويكا\n ❃∫ ملفات السورس ↓\n≪━━━━━━𝙎𝙊𝙐𝙍𝘾𝙀 𝙉𝙊𝙊𝙍━━━━━━≫\n\n"
local TextE = "\n≪━━━━━━𝙎𝙊𝙐𝙍𝘾𝙀 𝙉𝙊𝙊𝙍━━━━━━≫\n ❃∫ علامة تعني { ✓ } ملف مفعل\n ❃∫ علامة تعني { ✘ } ملف معطل\n ❃∫ قناة سورس بويكا ↓\n".." ❃∫ [اضغط هنا لدخول](https://t.me/source_noor) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevNOORW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/NOORTEAM/Files_NOOR/master/File_Bot/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevNOORW(msg) then
...
if text == "مسح الملفات" and DevNOORW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," ❃∫ تم مسح الملفات")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevNOORW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevNOORW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function Function_NOOR(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_NOOR, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_NOOR, nil)
return false 
end
...
------------------------------------------------------------------------
if text == 'تنزيل حمار' and Mod(msg) then
...
-----------------------------------------------------
if text == 'تنزيل مزه' and Mod(msg) then
...
if #list == 0 then
t = " ❃∫ مع الاسف لا يوجد مزه"
end
send(msg.chat_id_, msg.id_, t)
end
---------
if text == ("رفع المزه") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if (text == ("تنزيل المزه")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
---------
if text == ("رفع فرس") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'BO6OK')..')'
local  statuss  = '\n ❃∫ تم رفع فرس  في الجروب\n ❃∫تعالالي يفرس قلبي نت '
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if (text == ("تنزيل فرس")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
---------
if text == ("رفع معزه") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if (text == ("تنزيل معزه")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
---------
if text == ("رفع فار") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if (text == ("تنزيل فار")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
database:set(bot_id.."NOOR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."NOOR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ❃∫ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."NOOR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."NOOR1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."NOOR1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."NOOR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ❃∫ تم منع الكلمه مع التحذير")  
database:del(bot_id.."NOOR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."NOOR1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."NOOR1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."NOOR1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ❃∫ ارسل الكلمه الان")  
database:set(bot_id.."NOOR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."NOOR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."NOOR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."NOOR1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."NOOR1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."NOOR1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."NOOR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."NOOR1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."NOOR1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ❃∫ قائمة المنع \n≪━━━━━━𝙎𝙊𝙐𝙍𝘾𝙀 𝙉𝙊𝙊𝙍━━━━━━≫\n"
for k,v in pairs(list) do  
local NOOR_Msg = database:get(bot_id.."NOOR1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..NOOR_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevNOORW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ❃∫ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevNOORW(msg) then
...
if text == 'تفعيل الاذاعه' and DevNOORW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevNOORW(msg) then  
...
'هاا عايز اي ☹️.',
'مشايف اسمي ولا اي 😂.',
'قول ي حبي ؟ انا '..Namebot..'',
'مش فاضيلك',
'عمري فداك '..Namebot..' قول يحب'
}
send(msg.chat_id_, msg.id_,'['..NOOR_Msg[math.random(#NOOR_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevNOORW(msg) then 
...
if text == ("مسح ردود المطور") and DevNOORW(msg) then 
...
if text == ("ردود المطور") and DevNOORW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ❃∫ قائمة ردود المطور \n≪━━━━━━𝙎𝙊𝙐𝙍𝘾𝙀 𝙉𝙊𝙊𝙍━━━━━━≫\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevNOORW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevNOORW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل المغادره' and DevNOORW(msg) then   
...
if text == 'تعطيل المغادره' and DevNOORW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'NOOR')..') '
...
-- vardump(data) 
NOORdx(msg.chat_id_, msg.id_, ' ❃∫ ايدي المجموعة » ( '..msg.chat_id_..' )\n ❃∫ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ❃∫ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ❃∫ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevNOORW(msg) then
...
return false
  ...
  local Text =[[
    ...
    *❃م10 ◂ اوامر الاعضاء*
    ٴ≪━━━━━━𝙎𝙊𝙐𝙍𝘾𝙀 𝙉𝙊𝙊𝙍━━━━━━≫ٴ
    彡 .[NOOR 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](https://t.me/source_noor)➢ 
  ]]
  keyboard = {} 
  ...
  {
  {text = ' 𝙉𝙊𝙊𝙍{𝙉} 𝐓𝐄𝐀𝐌', url="https://t.me/source_noor"},
  },
  }
...
zh = https.request('https://rudi-dev.tk/Amir1/NOOR.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n❃∫ قائمه الزخرفه \nٴ❃∫ٴ≪━━━━━━𝙎𝙊𝙐𝙍𝘾𝙀 𝙉𝙊𝙊𝙍━━━━━━≫ٴ❃∫○ٴ \n"
i = 0
...
send(msg.chat_id_, msg.id_, t..'ٴ❃∫ٴ≪━━━━━━𝙎𝙊𝙐𝙍𝘾𝙀 𝙉𝙊𝙊𝙍━━━━━━≫ٴ❃∫○ٴ\n❃∫ 彡 .[NOOR 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](https://t.me/source_noor)➢ ')
end
...
gk = https.request('https://rudi-dev.tk/Amir2/NOOR.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://rudi-dev.tk/Amir3/NOOR.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
if data.ID == "UpdateNewCallbackQuery" then
  ...
  local Teext =[[
    ...
    ⌯︙ تحا
    •━━━━━━━━━•ٴ
    彡 .[𝘒𝘈 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](https://t.me/source_noor)➢
  ]]
  keyboard = {} 
  keyboard.inline_keyboard = {
  {
...
NOOR = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(NOOR)
...
------------------------------------------------------------------------
local NOORAbot = database:get(bot_id.."NOOR1:Add:Filter:Rp2"..text..result.chat_id_)   
if NOORAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❃∫ ["..NOORAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local NOOR1_Msg = database:get(bot_id.."NOOR1:Add:Filter:Rp2"..text..result.chat_id_)   
if NOOR1_Msg then    
send(msg.chat_id_, msg.id_," ❃∫ "..NOOR1_Msg)
